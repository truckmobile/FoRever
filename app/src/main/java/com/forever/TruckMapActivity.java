...
public class TruckMapActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mLogOut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                isLoggingOut = true;
                disconnectTruckDriver();
                FirebaseAuth.getInstance().signOut();
                Intent intent = new Intent(TruckMapActivity.this, MainActivity.class);
        ...
        mProfile.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(TruckMapActivity.this, UserProfileActivity.class);
                startActivity(intent);
                return;
            }
        });
        ...
        public void onLocationResult(LocationResult locationResult) {
            for (Location location : locationResult.getLocations()) {
                if (getApplicationContext() != null) {
                    ...
                    DatabaseReference myRef = FirebaseDatabase.getInstance().getReference("TrucksOnline");
                ...
                new AlertDialog.Builder(this)
                        ...
                        .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                ActivityCompat.requestPermissions(TruckMapActivity.this, new String[]
    ...
    /*private void connectTruckDriver(){
        checkLocationPermission();
        mFusedLocationClient.requestLocationUpdates(mLocationRequest, mLocationCallback, Looper.myLooper());
        mMap.setMyLocationEnabled(true);
    }*/

    private void disconnectTruckDriver(){
        if(mFusedLocationClient != null){
            mFusedLocationClient.removeLocationUpdates(mLocationCallback);

            String userId = FirebaseAuth.getInstance().getCurrentUser().getUid();
            DatabaseReference ref = FirebaseDatabase.getInstance().getReference("TrucksOnline");
